...
/*        if (args.length != 3) {
        ...
        * */
        ...
        new Example2("EUR", "10.0", "30.0").start();
    ...
    private boolean retrieveUnderlyingData() throws InterruptedException {
        ...
        Contract contract = createContract(underlyingData.getSymbol(), "FUT", "GLOBEX", "USD", "201209", "", 0.0);

        // Requests market data
        int requestId = RequestIDManager.singleton().getNextRequestId();
        eClientSocket.reqMktData(requestId, contract, GENERIC_TICKS, true);
